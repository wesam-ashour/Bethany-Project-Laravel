            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Dashboard
                        ...
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">FAQ</small>
                        <!--end::Description--></h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-ecommerce-forms-filter="search"
                                       class="form-control form-control-solid w-250px ps-14" placeholder="Search question or answer"/>
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                    ...
                                                    <div class="row">
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <textarea id="question"  class="form-control form-control-solid"
                                                                      placeholder="Enter a question" name="question"></textarea>
                                                            <!--end::Input-->
                                                            <strong id="question_error" class="errors text-danger"
                                                                    role="alert"></strong>
                                                        </div>
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <textarea id="answer"  class="form-control form-control-solid"
                                                                      placeholder="Enter a question" name="answer"></textarea>
                                                            <!--end::Input-->
                                                            <strong id="answer_error" class="errors text-danger"
                                                                    role="alert"></strong>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" id="kt_modal_edit_event_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bolder">Edit question info</h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                            <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <textarea id="question_u"  class="form-control form-control-solid"
                                                                   placeholder="Enter a question" name="question_u"></textarea>
                                                            <!--end::Input-->
                                                            <strong id="question_u_update_error" class="errors text-danger"
                                                                    role="alert"></strong>
                                                        </div>
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <textarea id="answer_u"  class="form-control form-control-solid"
                                                                      placeholder="Enter a answer" name="answer_u"></textarea>
                                                            <!--end::Input-->
                                                            <strong id="answer_u_update_error" class="errors text-danger"
                                                                    role="alert"></strong>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="modal fade" id="kt_modal_show_event" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" id="kt_modal_edit_event_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bolder">Question Info</h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                            <!--end::Close-->
                                        </div>
                                            ...
                                            <form id="kt_modal_update_event_form" class="form" action="#">
                                                ...
                                                <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <textarea disabled id="question_s"  class="form-control form-control"
                                                                      placeholder="Enter a question" name="question_s"></textarea>
                                                        </div>
                                                        ...
                                                        <div class="fv-row mb-7">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Input-->
                                                            <textarea disabled id="answer_s"  class="form-control form-control"
                                                                      placeholder="Enter a answer" name="answer_s"></textarea>
                                                            <!--end::Input-->
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="text-center pt-15">
                                                    <button type="button" class="btn btn-light me-3 " id="target"
                                                            data-dismiss="modal" aria-label="Close">Discard
                                                    </button>
                                                </div>
                                                <!--end::Actions-->
                                            </form>
            ...
            $(document).on('click', '#show', function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $("#question_s").val(response.question);
                        $("#answer_s").val(response.answer);
