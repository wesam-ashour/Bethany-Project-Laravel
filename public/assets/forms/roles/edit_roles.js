$(function () {
    ...
    function update_user() {
        submit_button.addEventListener('click', function () {
            $(".errors").html("");
            var formData = new FormData(document.getElementById('kt_modal_edit_user_only1'));// yourForm: form selector
            ...
            $.ajax({
                ...
                contentType: false,
                url: base_path + language + "/roles/" + $('#role_id').val(),
                data: formData,
    ...
    function success_submit() {
        //Success Submit
        $(".errors").html("");
        add_user_form.attr("data-kt-redirect", base_path + language +"/roles");
