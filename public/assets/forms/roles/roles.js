...
$(function () {
    ...
    function edit_user(id) {
        $.ajax({
            ...
            type: "GET",
            url: base_path + language + "/roles/" + id + "/edit",
            success: function (response) {
                $("#role_id").val(response.event.id);
                $("#name_u").val(response.event.name);
                $("#permission_u").append(response.rolePermissions)   ;
    ...
    function delete_user(id) {
        $.ajax({
            ...
            type: "DELETE",
            url: base_path + language + "/roles/" + id,
            success: function (response) {
                if (response['success']) {
                    Swal.fire({
